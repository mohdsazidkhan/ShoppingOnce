...
const Products = () => {
    ...
    return (
        <>
            <MetaData title="All Products | ShoppingOnce" />

            <main className="container m-auto mt-16">

                {/* <!-- row --> */}
                <div className="flex gap-3 mt-2 sm:mt-2 m-auto mb-7">
                    ...
                    <div className="hidden sm:flex flex-col w-1/5 px-1">
                        ...
                        <div className="flex flex-col bg-white rounded-sm shadow">
                            ...
                            <   div className="flex flex-col gap-2 border-b px-4 py-4">
                                {/* Products */}
                                    <span className="font-medium text-md">Total Products : {productsCount}</span>
                                </div>
                                {/* price slider filter */}
