...
const Stepper = ({ activeStep, children }) => {
    ...
    const steps = [
        ...
        },
        {
            ...
            desc: <p className="font-medium text-sm">{user.name} <span className="text-sm font-normal">{shippingInfo.address+', '+shippingInfo.landmark+', '+shippingInfo.city+', '+shippingInfo.pincode+', '+shippingInfo.state+', '+shippingInfo.country}</span></p>
        },
        {
            label: "ORDER SUMMARY",
