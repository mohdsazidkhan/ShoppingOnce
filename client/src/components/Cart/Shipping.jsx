...
const Shipping = () => {
    ...
    const shippingSubmit = (e) => {
        ...
        dispatch(saveShippingInfo({ address, city, landmark, country, state, pincode, phoneNo, userID}));
    ...
    return (
        <>
            ...
            <main className="w-full mt-20">
                ...
                {/* <!-- row --> */}
                <div className="flex flex-col sm:flex-row gap-3.5 container mt-0 sm:mt-4 m-auto sm:mb-7 overflow-hidden">
