...
const Sidebar = ({ activeTab, setToggleSidebar }) => {
    ...
    return (
        <aside className="sidebar z-10 sm:z-0 block min-h-screen fixed left-0 pb-14 max-h-screen w-3/4 sm:w-1/6 bg-gray-800 text-white overflow-x-hidden border-r">
            <div className="flex items-center gap-3 p-2 rounded-lg my-4 mx-3.5">
                <Avatar
                    alt="Avatar"
                    src={user.avatar.url}
                />
            ...
            <div className="flex flex-col gap-1 p-3 rounded-lg mb-6 mt-28 mx-3.5 overflow-hidden">
                <h5>Designed & Developed by:</h5>
                <div className="flex flex-col gap-0">
                    <a href="https://in.linkedin.com/in/sajidpahat786" target="_blank" rel="noreferrer" className="font-medium text-lg hover:text-blue-500">MOHD SAZID KHAN</a>
                    <a href="mailto:sajidpahat786@gmail.com" className="text-gray-300 text-sm hover:text-blue-500">sajidpahat786@gmail.com</a>
                </div>
            </div>
        </aside>
    )
